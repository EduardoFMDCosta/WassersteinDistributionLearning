...
def construct_trunc_mult_norm(mean, variance, support_assumption, **kwargs) -> TruncatedMultivariateNormal:
...
def construct_mixture_trunc_mult_norm(weight, mean, variance, support_assumption, **kwargs) -> MixtureTruncatedMultivariateNormal:
