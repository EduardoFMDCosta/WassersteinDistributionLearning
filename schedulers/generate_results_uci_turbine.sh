...
echo "-- UCI-Turbine --"
    echo "dim = 11, setting = 0"
    python -m experiments.generate_results --distribution UCI-Turbine --num_dims 11 --setting 0 --wasserstein_order "$rho" --method "$method"  --num_samples_training "$num_samples_training" --random_seed "$seed"
