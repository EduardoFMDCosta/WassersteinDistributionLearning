...
python -m experiments.partitions --distribution Uniform --num_dims 2 --setting 3
python -m experiments.partitions --distribution Uniform --num_dims 2 --setting 4

# python -m experiments.partitions --distribution Uniform --num_dims 3 --setting 0

python -m experiments.partitions --distribution Uniform --num_dims 10 --setting 0
python -m experiments.partitions --distribution Uniform --num_dims 10 --setting 1

python -m experiments.partitions --distribution Uniform --num_dims 25 --setting 0
python -m experiments.partitions --distribution Uniform --num_dims 25 --setting 1

python -m experiments.partitions --distribution Uniform --num_dims 50 --setting 0
python -m experiments.partitions --distribution Uniform --num_dims 50 --setting 1

python -m experiments.partitions --distribution Uniform --num_dims 75 --setting 0
python -m experiments.partitions --distribution Uniform --num_dims 75 --setting 1
