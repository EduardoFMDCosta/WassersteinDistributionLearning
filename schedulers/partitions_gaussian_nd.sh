...
python -m experiments.partitions --distribution Gaussian --num_dims 25 --setting 0 --random_seed "$seed"

python -m experiments.partitions --distribution Gaussian --num_dims 50 --setting 0 --random_seed "$seed"

python -m experiments.partitions --distribution Gaussian --num_dims 75 --setting 0 --random_seed "$seed"
